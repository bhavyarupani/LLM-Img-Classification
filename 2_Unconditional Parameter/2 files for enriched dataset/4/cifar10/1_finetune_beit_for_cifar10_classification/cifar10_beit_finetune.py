...
# Initialize wandb
wandb.init(project="cifar10-beit-finetuning")
...
model.load_state_dict(checkpoint, strict=False)  # Use strict=False to allow for mismatched sizes
...
# Evaluate the fine-tuned model on CIFAR-10
model.eval()
all_preds = []
all_labels = []
